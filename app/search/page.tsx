...
const dummy: SearchResultData = {
  contents: [
    {
      ...
      video: {
        ...
        movingThumbnails: [
          {
            height: 180,
            url: 'https://i.ytimg.com/an_webp/ScNNfyq3d_w/mqdefault_6s.webp?du=3000&sqp=CJz5k6YG&rs=AOn4CLCXKKYrBBjokVZijJaY8oI9OyhESg',
            width: 320,
          },
        ],
    ...
    },
    {
      ...
      video: {
        ...
        movingThumbnails: [
          {
            height: 180,
            url: 'https://i.ytimg.com/an_webp/D3MB_EkNV5Y/mqdefault_6s.webp?du=3000&sqp=CPr1k6YG&rs=AOn4CLBNTQpfmNKXgX3c_G6nbVzt0156iQ',
            width: 320,
          },
        ],
        publishedTimeText: '10 years ago',
    ...
    },
    {
      ...
      video: {
        ...
        movingThumbnails: [
          {
            height: 180,
            url: 'https://i.ytimg.com/an_webp/8Hr-IK8OdY0/mqdefault_6s.webp?du=3000&sqp=COiZlKYG&rs=AOn4CLBf2FVYSpBl4LlrOt0Es2ULKEgCkw',
            width: 320,
          },
        ],
  ...
  cursorNext:
    '%3D%3D',
  didYouMean: 'castle of glass',
  estimatedResults: 45757975,
  filterGroups: null,
  refinements: [
    'lost in the echo',
    ...
    <Box m='sm'>
      <form onSubmit={form.onSubmit((values) => onSearch(values.query))}>
        <TextInput
          ...
          icon={loading ? <Loader size={16} /> : <IconSearch size={16} />}
          disabled={loading}
